...
namespace LanReceiver.Protocol;
...
public static class NetPacket
{
        ...
        CancellationToken token)
    {
        ...
        {
            throw new InvalidOperationException($"送信データが大きすぎます: {payload.Length:n0} bytes");
        }
    ...
    public static async Task<ReceivedPacket?> ReadAsync(NetworkStream stream, CancellationToken token)
    {
        ...
        {
            throw new InvalidOperationException($"受信データ長が不正です: {payloadLength:n0} bytes");
        }
