...
public static class FfplayPathResolver
{
    public static string ResolveFfplayPath(string? configuredPath = null)
    {
        return ResolveExecutable(
            configuredPath,
            Environment.GetEnvironmentVariable("LAN_FFPLAY_PATH"),
            "ffplay.exe");
    }
